        ...
        <div className={navstyles.nav} ref={el}>
            ...
            <div className={styles}>
                ...
                <div className={navstyles.NavbarContainer}>
                    ...
                    <img className={navstyles.profileImage} width={60} height={60} src="https://res.cloudinary.com/seunsanyaa/image/upload/v1641303881/Rectangle_54_em9y46.png"/>

                        <h3 className={navstyles.name}>Eniola Ajibode</h3>

                    </div>
                    <div >
                        <button className={navstyles.menuMobile} onClick={() => setShowModal(true)}> <img src="data:image/svg+xml,%3Csvg width='36' height='36' viewBox='0 0 36 36' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M4.5 10.5H31.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3Cpath opacity='0.34' d='M4.5 18H31.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3Cpath d='M4.5 25.5H31.5' stroke='white' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E%0A"/>
                        </button>
